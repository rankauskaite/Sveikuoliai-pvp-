...
class HighPlantImageService {
  ...
  static String getPlantImagedobiliukas(int points) {
    if (points <= 2) {
      return 'assets/images/augalaiHigh/dobiliukas/1.png'; // Mažas daigelis
    } else if (points <= 4) {
      return 'assets/images/augalaiHigh/dobiliukas/2.png'; // Augantis augaliukas
    } else if (points <= 6) {
      return 'assets/images/augalaiHigh/dobiliukas/3.png'; // Bręstantis augalas
    } else {
      return 'assets/images/augalaiHigh/dobiliukas/4.png'; // Pilnai užaugęs augalas
    }
  }
  ...
  static String getPlantImagegervuoge(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 24) stage = 24; // Maksimalus etapas 24
    return 'assets/images/augalaiHigh/gervuoge/$stage.png';
  }
  ...
  static String getPlantImageorchideja(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 16) stage = 16; // Maksimalus etapas 16
    return 'assets/images/augalaiHigh/orchideja/$stage.png';
  }
  ...
  static String getPlantImageramuneles(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 6) stage = 6; // Maksimalus etapas 6
    return 'assets/images/augalaiHigh/ramuneles/$stage.png';
  }
  ...
  static String getPlantImagesaulegraza(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 12) stage = 12; // Maksimalus etapas 12
    return 'assets/images/augalaiHigh/saulegraza/$stage.png';
  }
  ...
  static String getPlantImagevysnia(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 36) stage = 36; // Maksimalus etapas 36
    return 'assets/images/augalaiHigh/vysnia/$stage.png';
  }
  ...
  static String getPlantImagezibuokle(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 8) stage = 8; // Maksimalus etapas 8
    return 'assets/images/augalaiHigh/zibuokle/$stage.png';
  }
}

class HighDeadPlantImageService {
  static String getPlantImage(String plantType, int points) {
    switch (plantType) {
      case 'dobiliukas':
        return getPlantImagedobiliukas(points);
  ...
  static String getPlantImagedobiliukas(int points) {
    if (points <= 2) {
      return 'assets/images/augalai_vytimasHigh/dobiliukas/1.png'; // Mažas daigelis
    } else if (points <= 4) {
      return 'assets/images/augalai_vytimasHigh/dobiliukas/2.png'; // Augantis augaliukas
    } else if (points <= 6) {
      return 'assets/images/augalai_vytimasHigh/dobiliukas/3.png'; // Bręstantis augalas
    } else {
      return 'assets/images/augalai_vytimasHigh/dobiliukas/4.png'; // Pilnai užaugęs augalas
    }
  }
  ...
  static String getPlantImagegervuoge(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 24) stage = 24; // Maksimalus etapas 24
    return 'assets/images/augalai_vytimasHigh/gervuoge/$stage.png';
  }
  ...
  static String getPlantImageorchideja(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 16) stage = 16; // Maksimalus etapas 16
    return 'assets/images/augalai_vytimasHigh/orchideja/$stage.png';
  }
  ...
  static String getPlantImageramuneles(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 6) stage = 6; // Maksimalus etapas 6
    return 'assets/images/augalai_vytimasHigh/ramuneles/$stage.png';
  }
  ...
  static String getPlantImagesaulegraza(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 12) stage = 12; // Maksimalus etapas 12
    return 'assets/images/augalai_vytimasHigh/saulegraza/$stage.png';
  }
  ...
  static String getPlantImagevysnia(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 36) stage = 36; // Maksimalus etapas 36
    return 'assets/images/augalai_vytimasHigh/vysnia/$stage.png';
  }
  ...
  static String getPlantImagezibuokle(int points) {
    ...
    if (stage < 1) stage = 1; // Minimalus etapas 1
    if (stage > 8) stage = 8; // Maksimalus etapas 8
    return 'assets/images/augalai_vytimasHigh/zibuokle/$stage.png';
  }
}
